...
--Solo se insertan datos en ejercicio, ya que el resto de las tablas dependen de la tabla usuario, y no se pueden insertar datos sin tener un usuario creado.
